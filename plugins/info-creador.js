...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `🐉𝙉𝙚𝙤𝙏𝙤𝙠𝙮𝙤 𝘽𝙚𝙖𝙩𝙨🐲`, dev, 'albertodovi100@gmail.com', `🇻🇪 Venezuela`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🐉`, `${packname}`, `📵 No Hacer Spam`, 'https://youtube.com/@NeoDragon-Beats-BY`, `https://github.com/TOKIO5025/Misa-amane-Bot`, biobot]
], m)
