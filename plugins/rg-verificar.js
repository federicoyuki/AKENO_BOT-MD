...
let name2 = conn.getName(m.sender)
  ...
  let perfil = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/v0l80y.jpg')
  let bio = 0, fechaBio
...
gracias por usar la bot si quieres usar la bot oficial unete l grupo donde esta la bot 
...
handler.help = ['reg']
handler.tags = ['rg']
handler.command = ['verify', 'r', 'verificar', 'reg', 'register', 'registrar'] 
