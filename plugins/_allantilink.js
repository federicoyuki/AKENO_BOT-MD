...
return m.reply(`la bot no es admin, no puedo eliminar a ese miemtro.`)
...
return m.reply(`ls bot no es admin, no puedo eliminar a ese miemtro.`)
} else if (!bot.restrict) {
return m.reply(`Las restricciones no estan activas.`)
}}  
...
return m.reply(`『✦』El bot no es admin, no puedo eliminar a ese miemtro.`)
} else if (!bot.restrict) {
return m.reply(`『✦』Las restricciones no estan activas.`)
}}
return !0
